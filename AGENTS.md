...
You can browse and install extra skills here: [https://github.com/moonbitlang/skills](https://github.com/moonbitlang/skills)
...
## Initial acceptance Git authorization

The user authorized local commits for every initial acceptance subgoal. Use Git identity ShiChengxu-creater for this repository. Do not push before initial acceptance implementation is complete. Keep publication separate from local verification. Do not change the global Git identity for this project.
